...
while True:
    ...
    subprocess.Popen(['psql -U adms-api -d adms -h gd.usc.edu -p 5433 -c \"COPY (SELECT link_id, date_and_time, speed FROM congestion.congestion_data WHERE date_and_time BETWEEN ' + tenMinStr + ' AND ' + currentStr + ') TO stdout DELIMITER \',\' CSV HEADER\" \ > C:\\Users\\namju\\OneDrive\\Documents\\GitHub\\imsc_sensor_speed\\production\\temp.csv'], env={'PGPASSWORD': 'V^YDiwdR&VvM'}, shell=True)
